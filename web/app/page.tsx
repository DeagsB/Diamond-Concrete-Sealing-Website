      ...
      <section id="gallery" className="py-12">
        <div className="container">
          ...
          <div className="gallery mt-4">
            <div className="g1"><Image alt="Sealed driveway" src="/images/image_2.jpg" width={800} height={600} priority className="rounded-md" blurDataURL={placeholders['image_2']} placeholder={placeholders['image_2'] ? 'blur' : undefined} /></div>
            <div className="g2"><Image alt="Sealed surface" src="/images/image_3.jpg" width={400} height={300} className="rounded-md" blurDataURL={placeholders['image_3']} placeholder={placeholders['image_3'] ? 'blur' : undefined} /></div>
            <div className="g3"><Image alt="Application detail" src="/images/image_4.jpg" width={400} height={300} className="rounded-md" blurDataURL={placeholders['image_4']} placeholder={placeholders['image_4'] ? 'blur' : undefined} /></div>
            <div className="g4"><Image alt="Clean prep" src="/images/image_5.jpg" width={400} height={300} className="rounded-md" blurDataURL={placeholders['image_5']} placeholder={placeholders['image_5'] ? 'blur' : undefined} /></div>
            <div className="g5"><Image alt="Finished sheen" src="/images/image_6.jpg" width={400} height={300} className="rounded-md" blurDataURL={placeholders['image_6']} placeholder={placeholders['image_6'] ? 'blur' : undefined} /></div>
            <div className="g6"><Image alt="Before and after" src="/images/image_7.jpg" width={400} height={300} className="rounded-md" blurDataURL={placeholders['image_7']} placeholder={placeholders['image_7'] ? 'blur' : undefined} /></div>
          </div>
        </div>
      </section>
